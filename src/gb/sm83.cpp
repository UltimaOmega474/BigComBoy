...
namespace Angbe
{
	...
	void SM83::service_interrupts()
	{
		...
		if (interrupt_pending)
		{
			/*
				...
				This happens regardless of IME which only controls whether or not the pending interrupts will be serviced.
			*/
	...
	{
		return registers[Register::F] & flagBit;
	}
	...
	void SM83::op_daa()
	{
		constexpr bool use_old_impl = true;
