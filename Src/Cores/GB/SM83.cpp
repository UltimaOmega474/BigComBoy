...
namespace GB
{
    ...
    std::array<SM83::opcode_function, 256> SM83::gen_optable()
    {
        return std::array<SM83::opcode_function, 256>{
            ...
            &SM83::op_ld_rp_a<RegisterPair::BC, NO_DISPLACEMENT>,
            ...
            &SM83::op_ld_a_rp<RegisterPair::BC, NO_DISPLACEMENT>,
            ...
            &SM83::op_ld_rp_a<RegisterPair::DE, NO_DISPLACEMENT>,
            ...
            &SM83::op_ld_a_rp<RegisterPair::DE, NO_DISPLACEMENT>,
            ...
            // 0x80 - 0x8F
            &SM83::op_add_a_r<Register::B, WITHOUT_CARRY>,
            &SM83::op_add_a_r<Register::C, WITHOUT_CARRY>,
            &SM83::op_add_a_r<Register::D, WITHOUT_CARRY>,
            &SM83::op_add_a_r<Register::E, WITHOUT_CARRY>,
            &SM83::op_add_a_r<Register::H, WITHOUT_CARRY>,
            &SM83::op_add_a_r<Register::L, WITHOUT_CARRY>,
            &SM83::op_add_a_r<Register::HL_ADDR, WITHOUT_CARRY>,
            &SM83::op_add_a_r<Register::A, WITHOUT_CARRY>,
            &SM83::op_add_a_r<Register::B, WITH_CARRY>,
            &SM83::op_add_a_r<Register::C, WITH_CARRY>,
            &SM83::op_add_a_r<Register::D, WITH_CARRY>,
            &SM83::op_add_a_r<Register::E, WITH_CARRY>,
            &SM83::op_add_a_r<Register::H, WITH_CARRY>,
            &SM83::op_add_a_r<Register::L, WITH_CARRY>,
            &SM83::op_add_a_r<Register::HL_ADDR, WITH_CARRY>,
            &SM83::op_add_a_r<Register::A, WITH_CARRY>,

            // 0x90 - 0x9F
            &SM83::op_sub_a_r<Register::B, WITHOUT_CARRY>,
            &SM83::op_sub_a_r<Register::C, WITHOUT_CARRY>,
            &SM83::op_sub_a_r<Register::D, WITHOUT_CARRY>,
            &SM83::op_sub_a_r<Register::E, WITHOUT_CARRY>,
            &SM83::op_sub_a_r<Register::H, WITHOUT_CARRY>,
            &SM83::op_sub_a_r<Register::L, WITHOUT_CARRY>,
            &SM83::op_sub_a_r<Register::HL_ADDR, WITHOUT_CARRY>,
            &SM83::op_sub_a_r<Register::A, WITHOUT_CARRY>,
            &SM83::op_sub_a_r<Register::B, WITH_CARRY>,
            &SM83::op_sub_a_r<Register::C, WITH_CARRY>,
            &SM83::op_sub_a_r<Register::D, WITH_CARRY>,
            &SM83::op_sub_a_r<Register::E, WITH_CARRY>,
            &SM83::op_sub_a_r<Register::H, WITH_CARRY>,
            &SM83::op_sub_a_r<Register::L, WITH_CARRY>,
            &SM83::op_sub_a_r<Register::HL_ADDR, WITH_CARRY>,
            &SM83::op_sub_a_r<Register::A, WITH_CARRY>,
            ...
            &SM83::op_add_a_r<Register::U8, WITHOUT_CARRY>,
            &SM83::op_rst_n<0x00>,
            ...
            &SM83::op_call_u16,
            &SM83::op_add_a_r<Register::U8, WITH_CARRY>,
            &SM83::op_rst_n<0x08>,
            ...
            &SM83::op_sub_a_r<Register::U8, WITHOUT_CARRY>,
            &SM83::op_rst_n<0x10>,
            ...
            &SM83::op_sub_a_r<Register::U8, WITH_CARRY>,
            &SM83::op_rst_n<0x18>,
    ...
    template <RegisterPair rp> inline void SM83::op_inc_rp()
    {
        ...
        case RegisterPair::BC:
        {
            high = &get_reg(Register::B);
            low = &get_reg(Register::C);
            break;
        }
        case RegisterPair::DE:
        {
            high = &get_reg(Register::D);
            low = &get_reg(Register::E);
            break;
        }
        case RegisterPair::HL:
        {
            high = &get_reg(Register::H);
            low = &get_reg(Register::L);
            break;
        }
        case RegisterPair::SP:
